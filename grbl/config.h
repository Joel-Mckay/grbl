...
#define HOMING_CYCLE_1 ((1<<X_AXIS)|(1<<Y_AXIS))  // OPTIONAL: Then move X,Y at the same time.
                 // OPTIONAL: Uncomment and add axes mask to enable
//#define HOMING_CYCLE_2 (1<<A_AXIS)
//#define HOMING_CYCLE_3 (1<<B_AXIS)
//#define HOMING_CYCLE_4 (1<<C_AXIS)
//#define HOMING_CYCLE_5 (1<<D_AXIS)
//#define HOMING_CYCLE_6 (1<<E_AXIS)
...
#define MAX_SPINDLE_SPEED_OVERRIDE        255 // Percent of programmed spindle speed (100-255). Usually 200%.
